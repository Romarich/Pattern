public class PatternRobots {
	...
	public static void main(String[] args) {
		Robot robot1= (Robot) new RobotImpl.RobotBuilder("R2D2").puissanceCanon(10).bouclier(2).frequenceDeTir(100).build();// un robot avec un canon de 10, un bouclier de 2, une fréquence de tir de 100 et qui a reçu une amélioration de canon multipliant la puissance de ce dernier par 2.
		Robot robot2= (Robot) new RobotImpl.RobotBuilder("C3PO").puissanceCanon(9).bouclier(3).frequenceDeTir(90).build();// un robot avec un canon de 9, un bouclier de 3, une fréquence de tir de 90 
